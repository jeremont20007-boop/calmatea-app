...
const FREE_FEATURES = [
  'Sonidos: Lluvia, Mar, Ruido Blanco',
  'Rutinas: Mañana y Escuela',
  'Botón de emergencia',
      ...
      <main className="flex-1 pb-24">
        ...
        <div className="p-4 space-y-4">
          <div className="text-center py-4">
            ...
            <h2 className="text-2xl font-extrabold text-calm-800">Elige tu plan</h2>
            <p className="text-calm-500 text-sm mt-1">Sin permanencia. Cancela cuando quieras.</p>
          </div>
          ...
          <div className={`rounded-3xl p-5 border-2 ${isPremium ? 'border-calm-100 bg-white opacity-60' : 'border-calm-300 bg-white'}`}>
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-3xl font-extrabold text-calm-700 mt-1">0€ <span className="text-base font-semibold text-calm-400">/mes</span></p>
              </div>
              {!isPremium && (
            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-3xl font-extrabold text-calm-700 mt-1">
                  4,99€ <span className="text-base font-semibold text-calm-400">/mes</span>
                </p>
              </div>
              {isPremium && (
          ...
          <p className="text-xs text-calm-400 text-center px-4">
            Pago seguro con Stripe. Puedes cancelar en cualquier momento desde el portal de cliente.
          </p>
        </div>
      </main>
      <BottomNav />
...
function ManageSubscriptionButton({ customerId }: { customerId: string }) {
  return (
    <form action="/api/stripe-portal" method="POST">
      ...
      <button
        type="submit"
        className="w-full text-calm-500 text-sm font-semibold hover:underline py-2"
      >
